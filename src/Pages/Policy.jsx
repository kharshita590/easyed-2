    ...
    <>
      ...
      <div className="container mx-auto mt-20 px-4">
        <p>
          ...
          Application shall mean and include the software and mobile application of Easyed accessed through or downloaded from the app store viz., Android or iOS, and accessible from any compatible device.
          ...
          Easyed shall mean any post by a registered user on the Application.
        </p>
        <br />
          ...
          <br />
          <br />
          <h1> <strong>1. ACCESS TO AND CONTINUED USE OF SERVICES</strong></h1>
          <br />
          <p>
          You should have attained the age of 13 to be able to use and access our Services. The Application has the right to terminate your account, wherein the User is found to be defaulting on this condition, or where we find that you are barred in law from access to our Services.
          You are responsible for your use of our Services, and undertake to comply with the applicable laws, and act in strict adherence to our Terms, Privacy Policy and Community Guidelines, as well.
          ...
          The Services provided to you are for your personal and non-commercial purposes only and should not be shared with individuals in violation of these Terms and allied policies. We specifically prohibit sale or purchase of a Easyed account or handle.
          ...
          The Company further reserves the right to restrict the circulation of any content if the said content violates the Community Guidelines of the App. The Company may also suspend or terminate your account for such a violation. Please refer to our other policies on how we moderate the Content.
          ...
          You agree not to use the accounts of other Users, disparage other accounts, or indulge in any activity which violates the Community Guidelines.
          ...
          We do not undertake any obligation to monitor user generated content, except to the extent required by law. We are an intermediary that primarily enables online interaction between two or more users and allows them to create, upload, share, disseminate, modify or access information using Easyed’s services. While Easyed supports valid and legitimate claims of intellectual property ownership, it does not adjudicate any claims. In the first instance, parties must resolve any disputes relating to intellectual property amongst themselves or through legal process, before reporting to Koo. If you believe that someone is violating your or anyone else’s intellectual property, you may report it by emailing to info@easyeduverse.com or by filling up this form. Please ensure that you submit complete details of the violation and ownership of the intellectual property in order for us to process the report. Such reports will typically be processed within 48 hours. Orders or directions of courts or legal authorities will be honoured on priority. The contents of a report (including any attachment) and the reporter’s email address will be provided to the person who posted the contested content along with a request to respond to the claim within 36 hours. If no response is received within the specified time, or, if in the sole discretion of Easyed, either the report or the response are unsatisfactory, Easyed will take such action as it deems fit. Please note that Easyed is acting on a best efforts basis and accepts no responsibility for any actions taken by it. Any assertion or adjudication of legal rights must be carried out through legal process. Any abuse of this process may lead to termination of your user account and/or other legal consequences. Please do not hesitate to seek your own legal advice before filing or contesting any report for intellectual property violation.
          ...
          <br />
          <h1><strong> 2. SERVICES</strong></h1>
          <br />
          <p>
          ...
          <br />
          <h1> <strong>3. REGISTRATION AND ACCOUNT INTEGRITY</strong></h1>
          <br />
          <p>
          ...
          Please note that if a username has been used by a verified user on another platform, in order to avoid risk of impersonation, the username will not be allotted to anyone else and, if already allotted, may be cancelled at the discretion of Easyed without any notice. Please review our policies related to Eminence in this regard
          We reserve the right to suspend or terminate or remove any account or take any other actions we deem fit with or without notice, if you are in breach of these Terms. In case you have any concern regarding an action taken on your account you can file an appeal by mailing to us on info@easyeduverse.com.
          In case of any discrepancy in access to your account, please reach out to us as per the account terms.
          </p>
          <br />
          <h1><strong>4. THIRD PARTY SERVICES</strong></h1>
          <br />
          <p>
          ...
          In compliance with legal requirements, advertisements or promotional content will be dealt in accordance with our Advertiser Guidelines. By using the Easyed App, you agree to the measures implemented by us in this regard.
          </p>
          <br />
          <h1><strong>5. RULES AND CONDUCT</strong></h1>
          <br />
          <p>


          Without foregoing the responsibilities ascribed to you under these Terms, and without foregoing the generality of the Community Guidelines, and allied policies, you are prohibited from publishing any Content which:
          ...
          The User has the provision to appeal the suspension or termination of the account by contacting info@easyeduverse.com or by submitting this appeal form.
          ...
          DO NOT USE ANY SOFTWARE, DEVICE, SCRIPTS, BOTS OR OTHER MEANS TO ACCESS, SCRAPE, CRAWL OR SPIDER THE APPLICATION FOR ANY TYPE OF PUBLIC AND PRIVATE DATA OR INFORMATION. UNLESS YOU RECEIVE EXPLICIT PERMISSION BY EASYED IN WRITING, YOU MUST NOT:
          ...
          <br />
          <h1><strong>9. INDEMNITY</strong></h1>
          <br />
          <p>
          ...
          <br />
          <h1><strong>10. LIMITATION OF LIABILITY</strong></h1>
          <br />
          <p>
          ...
          FOR ANY DIRECT DAMAGES IN EXCESS (IN THE AGGREGATE) OF THE INR 10,000/- (in case of India) and USD 150 (in case of countries other than India);
          ...
          <br />
          <h1><strong>11. GOVERNING LAW</strong></h1>
          <br />
          <p>
          ...
          <br />
          <h1><strong>12. MISCELLANEOUS</strong></h1>
          <br />
          <p>

          In the event that any provision of these Terms is held to be invalid or unenforceable, then that provision will be limited or eliminated to the minimum extent necessary, and the validity, legality, and enforceability of the remaining provisions shall remain in full force and effect.
          These Terms form a valid, enforceable agreement between you and Easyed Eduverse Private Limited, a company incorporated under the Companies Act, 2022 with our registered office at 3083, Tower 4, Mahagun mywoods, Gaur city 2, Noida, Uttar pradesh - 201301.
          </p>
          <br />
          <h1><strong>
          ...
          Mr. Abhishek Ranjan, Founder, 3083, Tower 4, Mahagun mywoods, Gaur city 2, Noida, Uttar pradesh - 201301 .
          A Grievance Redressal Process in accordance with applicable law has been created and is available on the Compliance page on our website.
          </p>
          <br />
          <h1><strong>
          14. REFERENCE
          ...
          <br />
          <p>
          If you have any questions regarding the Service, please contact Koo at info@easyeduverse.com
